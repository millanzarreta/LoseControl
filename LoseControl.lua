...
local abilities = {
-- This is our list of debuffs to check for.
-- I don't use spellIDs because there are too many ranks and I don't use texture icons because Blizzard re-uses too many of them for other spells.
