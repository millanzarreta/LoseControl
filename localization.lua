...
if locale == "deDE" then -- translated by Morbis
	...
	L["Yes"] = "Yes"
	L["No"] = "No"
	L["Yes (recomended)"] = "Yes (recomended)"
	L["LOSECONTROL_CHECKINCOMPATIBILITIES_MSG_L1"] = "It has been detected that the 'ClassicAuraDurations' addon is installed"
	L["LOSECONTROL_CHECKINCOMPATIBILITIES_MSG_L2A"] = " and that the 'Show Portrait Icon' and 'Player Portrait Icon' functionalities are enabled, which allow "
	L["LOSECONTROL_CHECKINCOMPATIBILITIES_MSG_L2B"] = " and that the 'Show Portrait Icon' functionality is enabled, which allows "
	L["LOSECONTROL_CHECKINCOMPATIBILITIES_MSG_L2C"] = " and that the 'Player Portrait Icon' functionality is enabled, which allows "
	L["LOSECONTROL_CHECKINCOMPATIBILITIES_MSG_L3"] = "to show special icons for important auras in the portrait icon.\n"
	L["LOSECONTROL_CHECKINCOMPATIBILITIES_MSG_L4"] = "LoseControl covers the same functionality as this feature, so it is recommended to disable "
	L["LOSECONTROL_CHECKINCOMPATIBILITIES_MSG_L5"] = " of the 'ClassicAuraDurations' addon to avoid strange behaviors, such as duplicate timers and icons.\n"
	L["LOSECONTROL_CHECKINCOMPATIBILITIES_MSG_L6"] = "You can always re-enable "
	L["LOSECONTROL_CHECKINCOMPATIBILITIES_MSG_L7"] = " in the configuration menu of the 'ClassicAuraDurations' addon if you wish.\n"
	L["LOSECONTROL_CHECKINCOMPATIBILITIES_MSG_L8"] = "Do you want LoseControl to disable "
	L["LOSECONTROL_CHECKINCOMPATIBILITIES_MSG_L9"] = " of  'ClassicAuraDurations' addon to maximize compatibility?\n"
	L["LOSECONTROL_CHECKINCOMPATIBILITIES_OPT_1A"] = "this option"
	L["LOSECONTROL_CHECKINCOMPATIBILITIES_OPT_1B"] = "these options"
elseif locale == "esES" or locale == "esMX" then -- translated by Babelfish and millanzarreta
	...
	L["Yes"] = "Si"
	L["No"] = "No"
	L["Yes (recomended)"] = "Si (recomendado)"
	L["LOSECONTROL_CHECKINCOMPATIBILITIES_MSG_L1"] = "Se ha detectado que el addon 'ClassicAuraDurations' está instalado y que"
	L["LOSECONTROL_CHECKINCOMPATIBILITIES_MSG_L2A"] = " las funcionalidades 'Show Portrait Icon' y 'Player Portrait Icon' están habilitadas, las cuales permiten "
	L["LOSECONTROL_CHECKINCOMPATIBILITIES_MSG_L2B"] = " la funcionalidad 'Show Portrait Icon' está habilitada, la cual permite "
	L["LOSECONTROL_CHECKINCOMPATIBILITIES_MSG_L2C"] = " la funcionalidad 'Player Portrait Icon' está habilitada, la cual permite "
	L["LOSECONTROL_CHECKINCOMPATIBILITIES_MSG_L3"] = "mostrar iconos especiales para auras importantes en el icono de retrato.\n"
	L["LOSECONTROL_CHECKINCOMPATIBILITIES_MSG_L4"] = "LoseControl cubre la misma funcionalidad que esta característica, por lo que se recomienda deshabilitar "
	L["LOSECONTROL_CHECKINCOMPATIBILITIES_MSG_L5"] = " del addon 'ClassicAuraDurations' para evitar comportamientos extraños, como temporizadores e iconos duplicados.\n"
	L["LOSECONTROL_CHECKINCOMPATIBILITIES_MSG_L6"] = "Siempre podrás volver a habilitar "
	L["LOSECONTROL_CHECKINCOMPATIBILITIES_MSG_L7"] = " en el menú de configuración del addon 'ClassicAuraDurations' si lo deseas.\n"
	L["LOSECONTROL_CHECKINCOMPATIBILITIES_MSG_L8"] = "¿Desea que LoseControl deshabilite "
	L["LOSECONTROL_CHECKINCOMPATIBILITIES_MSG_L9"] = " del addon 'ClassicAuraDurations' para maximizar la compatibilidad?\n"
	L["LOSECONTROL_CHECKINCOMPATIBILITIES_OPT_1A"] = "esta opción"
	L["LOSECONTROL_CHECKINCOMPATIBILITIES_OPT_1B"] = "estas opciones"
