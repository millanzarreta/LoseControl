...
if locale == "deDE" then -- translated by dejaspeed
	LOSECONTROL = {
		...
		["Immune"]  = "Immun",
		["Immune to Spells"] = "Immun to Spells",
		["PvE"]     = "PvE Überwachen",
		["player"] = "Spieler",
		["target"] = "Ziel",
		["focus"]  = "Fokus",
...
elseif locale == "zhCN" then -- translated by fatalerror
	LOSECONTROL = {
		["CC"]      = "控制类技能",
		["Silence"] = "沉默类技能",
		["Disarm"]  = "缴械类技能",
		...
		["Disable OmniCC/CooldownCount Support"] = "屏蔽 OmniCC/CooldownCount 支持",
		["Tracking"] = "监视",
		["LoseControl reset."] = "LoseControl 已重置.",
	}
elseif locale == "zhTW" then -- translated by fatalerror
	LOSECONTROL = {
		["CC"]      = "控制類技能",
		["Silence"] = "沉默類技能",
		["Disarm"]  = "繳械類技能",
		...
		["Opacity"] = "透明度",
		["Unlock"] = "解鎖",
		[" (drag an icon to move)"] = " (拖動圖標移動)",
		["Disable OmniCC/CooldownCount Support"] = "關閉 OmniCC/CooldownCount 支持",
		["Tracking"] = "監視",
		["LoseControl reset."] = "LoseControl 已重置.",
	}
